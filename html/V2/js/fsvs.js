	...
	$.fn.fsvs = function( options ) {
		...
		var app = {
			...
			canSlideDown: function () {
				...
				//alert($(options.selector, body).eq((currentSlideIndex + 1)).length)
				
				//$('.side7_right, .side7_title_f, .side_box.side7bg .more').removeClass('show')
//				$('.side1_logo, .side1_slogan').removeClass('show')
//				$('.card_Container').removeClass('show')
//				$('.side6_right, .side6_title_f, .side_box.side6bg .more').removeClass('show')
				
			    if ($(options.selector, body).eq((currentSlideIndex + 1)).length === 0) {
			         $("#nav_d" + currentSlideIndex).css({ "top": "-40px", "opacity": "1" }).addClass("_transition");
					 if (currentSlideIndex == 6) { 
						$('.side7_right, .side7_title_f').addClass('show')
						setTimeout(function(){
        						$('.side_box.side7bg .more').addClass('show')
    						},1000);
			        	 }
			        ...
			        if (currentSlideIndex == 5) { 
						$('.side6_right, .side6_title_f').addClass('show')
						setTimeout(function(){
        						$('.side_box.side6bg .more').addClass('show')
    						},1000);
			        }
